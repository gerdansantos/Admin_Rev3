...
echo "Starting node1..."
CID_namenode=$(docker run -d --privileged=true --dns 127.0.0.1 -p 8080:8080 -p 8440:8440 -p 8441:8441 -p 50070:50070 -p 50075:50075 -p 8020:8020 -e NODE_TYPE=namenode --name node1 -h node1 -i -t hwx/ambari_server)
